...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  return {
    title: `Online ${baseTitle} | Digital Ghuru`,
    description: `Enroll in Digital Ghuru's Online ${baseTitle}. Learn from anywhere with live interactive classes, real-world projects, and 100% placement support.`,
  };
}
...
export default async function OnlineCoursePage({
  ...
  // Inject "Online" for SEO and local context
  finalCourse = {
    ...finalCourse,
    title: `Online ${finalCourse.title}`,
    subtitle: finalCourse.subtitle ? `${finalCourse.subtitle} — Learn From Anywhere` : "Live Online Interactive Training",
  };
